...
const Footer = () => {
  return (
    <footer className="bg-cyan-950">
      <div className="py-8 flex flex-row gap-6 justify-center sm:gap-16 sm:justify-between mx-14 flex-wrap font-['Montserrat']  items-start space-y-4 md:flex-row space-x-0 lg:space-x-8 md:items-start">
        ...
        <div className="flex flex-col space-y-2 ">
          ...
          <p className="text-sm">
            ...
            <span className="text-gray-100 px-2 py-1">+251983334785</span>
          </p>
          <p className="text-sm">
            <FaPhoneAlt className="inline text-gray-100" />
            <span className="text-gray-100 px-3 py-1">
      ...
      <div className="bg-cyan-950 text-gray-100 py-8 text-center font-['Kanit']">
