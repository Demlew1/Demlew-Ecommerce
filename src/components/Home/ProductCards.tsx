  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      {productsWithImages.length === 0 ? (
        <p className="font-['Rubik'] text-center text-gray-500 mt-10">
          No search results
        </p>
      ) : (
          ...
          {productsWithImages.map((product) => (
            ...
            >
              ...
              <div className="card-body items-center text-center flex flex-col gap-3 flex-1">
                <h2 className="card-title text-cyan-950 px-2">
                  {product.title}
                </h2>
                ...
                <div className="card-actions">
                  <button
                    ...
                    className="btn btn-primary bg-cyan-950 text-cyan-50 p-2 w-40 border-1 border-cyan-950 cursor-pointer hover:border-cyan-950 hover:text-cyan-950 hover:bg-white text-sm"
                  >
                    More details
                  </button>
                </div>
